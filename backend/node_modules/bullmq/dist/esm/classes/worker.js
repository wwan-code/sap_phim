        ...
        return this.trace(SpanKind.CONSUMER, 'process', this.name, async (span) => {
            ...
            try {
                ...
                if (unrecoverableErrorMessage) {
                    const failed = await this.retryIfFailed(() => this.handleFailed(new UnrecoverableError(unrecoverableErrorMessage), job, token, fetchNextCallback, jobsInProgress, inProgressItem, span), this.opts.runRetryDelay);
                    return failed;
                }
